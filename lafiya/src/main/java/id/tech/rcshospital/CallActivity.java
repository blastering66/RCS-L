...
public class CallActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;		
		ls = (ListView)findViewById(R.id.ls_call);
		...
		imgIklan.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				PublicFunction.BukaBanner(CallActivity.this, indexIklan);
			}
		});
...
//			p.add(new BasicNameValuePair("idC", "1"));			
		...
		protected void onPostExecute(Void result) {
			...
			dialog.dismiss();
			if(berhasil == 1){
				adapter = new CustomAdapterHospitalInfo(mContext, 1, 0, data_row);			
